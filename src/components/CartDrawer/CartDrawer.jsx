...
export default function CartDrawer({ isOpen, onClose, onToast }) {
                ...
                {cartItems.length === 0 ? (
                    ...
                    <>
                                ...
                                <div key={item.id} className="cart-item">
                                    ...
                                    <div className="cart-item-details">
                                        ...
                                        <div className="cart-item-actions">
                                            ...
                                            <button type="button" className="remove-item-button" onClick={() => handleRemoveItem(item)}>
                                                Remove
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div className="cart-summary-panel">
                            ...
                            <button type="button" className="clear-cart-button" onClick={() => handleClearCart()}>Clear cart</button>
                        </div>
                    </>
                )}
            </aside>
